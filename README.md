...
| [Hermes Agent](docs/tracks/hermes-agent-framework-research.md) | Run the persistent agent with an [SSH-only messaging bridge](docs/runbooks/hermes-mcp-ssh.md) and separate [agent delegation MCP](docs/runbooks/hermes-delegation-mcp-ssh.md) |
