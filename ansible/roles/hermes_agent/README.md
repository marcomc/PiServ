...
| `hermes_agent_home_assistant_mcp_token_env_file` | `{{ hermes_agent_home }}/home-assistant-mcp.env` | Pre-provisioned private `KEY=value` token file; its `0700` parent and `0600` file must belong to the runtime identity. |
