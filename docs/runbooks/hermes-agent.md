...
6. Open **Settings > Voice assistants > Expose**, then expose the intended
   entity to **Assist**. The MCP Server uses the Assist exposure list; it has
   no separate per-entity configuration page.
